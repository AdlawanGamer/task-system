...
public class ViewAllTaskPage extends javax.swing.JFrame {
    ...
    /**
     * Creates new form ViewAllTaskPage
     */
    ...
    public void displayData(){
        try{
            ...
            ResultSet rs = dbc.getData("SELECT task.t_id,task.t_name,employee.u_fullname,task.t_deadline,task.t_status "
                    + "FROM employee "
                    + "INNER JOIN task ON employee.u_id = task.u_id "
    ...
    private void initComponents() {
        ...
        jLabel3.setText("List of all Task Details");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(560, 80, 190, 22);
        ...
        jButton6.setBounds(170, 470, 180, 25);
