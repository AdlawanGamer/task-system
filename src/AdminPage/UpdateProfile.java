...
public class UpdateProfile extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jFullName.setBounds(60, 190, 240, 30);
        ...
        jContactNumber.setBounds(60, 260, 240, 30);
        ...
        jPosition.setBounds(560, 260, 180, 30);
        ...
        jPanel2.add(jGender);
        jGender.setBounds(560, 190, 180, 30);

        jLabel13.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel13.setText("Username");
        jPanel2.add(jLabel13);
        jLabel13.setBounds(320, 290, 90, 20);

        jUsername.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jPanel2.add(jUsername);
        jUsername.setBounds(320, 260, 220, 30);
