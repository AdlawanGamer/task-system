...
public class AddEmployee extends javax.swing.JFrame {
    ...
    public static boolean checkUserName(String username){
        ...
        try{
            String query = "SELECT * FROM employee WHERE u_username = '"+username+"'";
    ...
    private void initComponents() {
        ...
        jUsername.setBounds(60, 330, 200, 30);
        ...
        jConfirmPassword.setBounds(520, 360, 120, 20);

        jPasswordField.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jPanel2.add(jPasswordField);
        jPasswordField.setBounds(280, 330, 220, 30);
        ...
        jRegisterButton.setBounds(160, 430, 220, 30);

        jLabel6.setFont(new java.awt.Font("Segoe UI", 1, 16)); // NOI18N
        jLabel6.setText("Fill up form for new employee");
        jPanel2.add(jLabel6);
        jLabel6.setBounds(60, 140, 330, 22);

        jFullName.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jPanel2.add(jFullName);
        jFullName.setBounds(60, 190, 200, 30);

        jLabel7.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel7.setText("Full Name");
        jPanel2.add(jLabel7);
        jLabel7.setBounds(60, 220, 70, 20);

        jContactNumber.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jPanel2.add(jContactNumber);
        jContactNumber.setBounds(280, 190, 160, 30);
        ...
        jPanel2.add(jGender);
        jGender.setBounds(620, 190, 120, 30);

        jLabel13.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel13.setText("Address");
        jPanel2.add(jLabel13);
        jLabel13.setBounds(60, 290, 90, 20);
    ...
    private void jRegisterButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRegisterButtonActionPerformed
        ...
        dbConnector dbc = new dbConnector();
        String query = "INSERT INTO employee ( u_fullname, u_contactnumber, u_birthday, u_gender, u_address, u_position, u_username, u_password, u_status) VALUES ("
                + "'" + fullname + "',"
                + "'"+ contactnumber +"',"
                + "'"+ birthday +"',"
                + "'"+ gender +"',"
