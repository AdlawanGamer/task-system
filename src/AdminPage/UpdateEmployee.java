...
public class UpdateEmployee extends javax.swing.JFrame {
    ...
    public static boolean checkUserName(String username, int ID){
        ...
        try{
            String query = "SELECT * FROM employee WHERE u_username = '"+username+"' AND u_id != '" + ID + "'";
    ...
    private void initComponents() {
        ...
        jLoginButton.setBounds(410, 410, 220, 30);
        ...
        jRegisterButton.setBounds(160, 410, 220, 30);
        ...
        jFullName.setBounds(260, 190, 240, 30);
        ...
        jContactNumber.setBounds(60, 260, 180, 30);
        ...
        jContactNumberLabel.setBounds(60, 290, 110, 20);
        ...
        jPanel2.add(jGender);
        jGender.setBounds(260, 260, 240, 30);

        jLabel13.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel13.setText("Status");
        jPanel2.add(jLabel13);
        jLabel13.setBounds(620, 360, 90, 20);

        jUsername.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jPanel2.add(jUsername);
        jUsername.setBounds(390, 330, 210, 30);

        jLabel14.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel14.setText("Address");
        jPanel2.add(jLabel14);
        jLabel14.setBounds(60, 360, 90, 20);

        jLabel8.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel8.setText("Full Name");
        jPanel2.add(jLabel8);
        jLabel8.setBounds(260, 220, 70, 20);

        jID.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jPanel2.add(jID);
        jID.setBounds(60, 190, 180, 30);
        ...
        jPanel2.add(jStatus);
        jStatus.setBounds(620, 330, 120, 30);

        jLabel15.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel15.setText("Username");
        jPanel2.add(jLabel15);
        jLabel15.setBounds(390, 360, 90, 20);
