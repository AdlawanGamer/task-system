...
public class ListOfEmployee extends javax.swing.JFrame {
    ...
    /**
     * Creates new form ViewPeoplePage
     */
    ...
    public void displayUser_Role(){
        ...
        jAdminRole.setText("" + session.getPosition());
    }
    //display table data
    public void displayData(){
        try{
            dbConnector dbc = new dbConnector();
            ResultSet rs = dbc.getData("SELECT u_id,u_fullname,u_position,u_contactnumber,u_status FROM employee");
            ...
            jEmployeeTable.getTableHeader().setBackground(Color.decode("#9AD0D3"));
    ...
    public boolean getEmployeeDetails(int ID){
        ...
        try{
            String query = "SELECT * FROM employee WHERE u_id = '" + ID + "'";
            ResultSet resultset = connector.getData(query);
            if(resultset.next()){
                id = resultset.getInt("u_id");
                name = resultset.getString("u_fullname");
                birthdate = resultset.getDate("u_birthday");
                gender = resultset.getString("u_gender");
                contactnumber = resultset.getString("u_contactnumber");
                username = resultset.getString("u_username");
                position = resultset.getString("u_position");
                address = resultset.getString("u_address");
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel3);
        jLabel3.setBounds(380, 130, 190, 22);
        ...
        jScrollPane1.setBounds(160, 230, 630, 230);
        ...
        jButton6.setBounds(160, 470, 150, 25);
    ...
    private void jButtonDELETEActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDELETEActionPerformed
        ...
        if (selectedRow >= 0) {
            ...
            if (confirm == JOptionPane.YES_OPTION) {
                ...
                String query = "DELETE FROM employee WHERE u_id = '" + ID + "'";
                dbConnector dbc = new dbConnector();
    ...
    private void jSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jSearchKeyReleased
        ...
        if (!searchText.isEmpty()) {
            try {
                ...
                String query = "SELECT u_id, u_fullname, u_position, u_contactnumber, u_status FROM employee WHERE u_id = " + ID;
